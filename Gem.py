...
try:
    ...
    time.sleep(1)
    os.system('Then type: python2 india')
...
def login():
    ...
    print
    print
    jalan('\x1b[1;91m[\x1b[1;92m1\x1b[1;91m]  \x1b[1;93mSTAR PROGRAM    ')
    print
